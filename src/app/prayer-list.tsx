...
export default function PrayerListScreen() {
  ...
  const addUpdate = async () => {
    ...
    const updatedList = prayers.map((p) =>
      p.id === selectedPrayer.id ? updatedPrayer : p,
    );
          ...
          return (
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                {item.description ? (
                  <Text style={styles.prayerDesc} numberOfLines={1}>
                    {item.description}
                  </Text>
                ) : null}
              ...
              <View style={styles.prayerRight}>
                ...
                {item.isPrivate && (
                  <FontAwesome6 name="lock" size={11} color="#555" />
                )}
              </View>
            </Pressable>
          );
                  ...
                  <View style={styles.detailHead}>
                    ...
                    {selectedPrayer.answeredAt && (
                      <Text style={[styles.detailDate, { color: "#4ade80" }]}>
                        ...
                        />{" "}
                        Answered{" "}
                        {new Date(selectedPrayer.answeredAt).toLocaleDateString(
                          "default",
                          { month: "long", day: "numeric", year: "numeric" },
                        )}
                      </Text>
                  ...
                  <View style={styles.updateSection}>
                    ...
                    {selectedPrayer.updates.length === 0 && (
                      <Text style={styles.noUpdates}>
                        No updates yet. You can journal your prayer journey
                        here.
                      </Text>
                    )}
